...
use crate::gpio::*;
use crate::hw_traits::timera::{CCRn, Outmod};
...
// impl PwmPeriph<CCR0> for pac::TB0 {
...
impl PwmPeriph<CCR1> for pac::TA0 {
    type Gpio = Pin<P1, Pin1, Alternate2<Output>>;
    const ALT: Alt = Alt::Alt2;
}
impl PwmPeriph<CCR2> for pac::TA0 {
    type Gpio = Pin<P1, Pin2, Alternate2<Output>>;
    const ALT: Alt = Alt::Alt2;
}

impl PwmPeriph<CCR1> for pac::TA1 {
    type Gpio = Pin<P1, Pin5, Alternate2<Output>>;
    const ALT: Alt = Alt::Alt2;
}
impl PwmPeriph<CCR2> for pac::TA1 {
    type Gpio = Pin<P1, Pin4, Alternate2<Output>>;
    const ALT: Alt = Alt::Alt2;
}

impl PwmPeriph<CCR0> for pac::TA2 {
    type Gpio = Pin<P5, Pin6, Alternate2<Output>>;
    const ALT: Alt = Alt::Alt2;
}
impl PwmPeriph<CCR1> for pac::TA2 {
    type Gpio = Pin<P5, Pin7, Alternate1<Output>>;
    const ALT: Alt = Alt::Alt1;
}
impl PwmPeriph<CCR2> for pac::TA2 {
    type Gpio = Pin<P6, Pin0, Alternate1<Output>>;
    const ALT: Alt = Alt::Alt1;
}

impl PwmPeriph<CCR0> for pac::TA3 {
    type Gpio = Pin<P4, Pin1, Alternate1<Output>>;
    const ALT: Alt = Alt::Alt1;
}
impl PwmPeriph<CCR1> for pac::TA3 {
    type Gpio = Pin<P4, Pin0, Alternate1<Output>>;
    const ALT: Alt = Alt::Alt1;
}
impl PwmPeriph<CCR2> for pac::TA3 {
    type Gpio = Pin<P4, Pin5, Alternate1<Output>>;
    const ALT: Alt = Alt::Alt1;
}
// impl PwmPeriph<CCR3> for pac::TA3 {
//     type Gpio = Pin<P3, Pin7, Alternate1<Output>>;
//     const ALT: Alt = Alt::Alt1;
// }
// impl PwmPeriph<CCR4> for pac::TA3 {
//     type Gpio = Pin<P6, Pin3, Alternate1<Output>>;
//     const ALT: Alt = Alt::Alt1;
// }
// impl PwmPeriph<CCR5> for pac::TA3 {
//     type Gpio = Pin<P4, Pin3, Alternate2<Output>>;
//     const ALT: Alt = Alt::Alt2;
// }
// impl PwmPeriph<CCR6> for pac::TA3 {
