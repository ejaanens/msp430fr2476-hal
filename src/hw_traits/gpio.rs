     ...
     $(, [$pxies:ident, $pxie:ident, $pxifg:ident, $pxiv:ident])?
        ...
        mod $px {
            ...
            impl GpioPeriph for pac::$Px {
                ...
                #[inline(always)]
                fn pxout_toggle(&self, _bits: u8) {
                    unsafe { self.$pxout.modify(|r,w| w.bits(!r.bits())) };
                }
