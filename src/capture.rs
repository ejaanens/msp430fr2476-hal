...
use crate::gpio::*;
use crate::hw_traits::timera::{CCRn, Ccis, Cm};
use crate::timer::{read_taxiv, CapCmpTimer3, CapCmpTimer7, TimerVector};
...
//    type Gpio6 = ();
// }
impl CapturePeriph for pac::TA0 {
   type Gpio0 = ();
...
impl CapturePeriph for pac::TA1 {
   type Gpio0 = ();
...
impl CapturePeriph for pac::TA2 {
...
impl CapturePeriph for pac::TA3 {
   ...
   type Gpio2 = Pin<P4, Pin5, Alternate1<Input<Floating>>>;
   type Gpio3 = Pin<P3, Pin7, Alternate1<Input<Floating>>>;
...
pub struct TAxIV<T: TimerPeriph>(PhantomData<T>);

impl<T: TimerPeriph> TAxIV<T> {
   #[inline]
